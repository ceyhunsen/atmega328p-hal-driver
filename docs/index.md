...
Please note that users needs to refer data-sheet while using this library. Some
of the functions doesn't explain how that module behaves and it is expected that
the user knows the procedures.
